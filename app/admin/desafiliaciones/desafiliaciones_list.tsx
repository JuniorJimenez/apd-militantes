...
const ESTADOS = ['TODOS','PENDIENTE','RECIBIDA','REMITIDA','CERRADA','RECHAZADA','ARCHIVADA'] as const
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
          {(['PENDIENTE','RECIBIDA','REMITIDA','CERRADA','RECHAZADA','ARCHIVADA'] as const).map(e => (
